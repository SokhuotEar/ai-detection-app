...
def process_directory(directory, label):
    ...
    return pd.DataFrame(features, columns=['readability', 'perplexity', 'lexical_density', 'avg_word_length', 'ngram_diversity', 'avg_sentence_length']), pd.Series([label] * len(texts))
...
if __name__ == "__main__":
    ...
    test_texts = [
        ...
        "The solar system is a vast expanse centered around our Sun, a medium-sized star in the Milky Way galaxy. It consists of eight planets: Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, and Neptune, orbiting the Sun at varying distances. These planets are accompanied by numerous moons, asteroids, comets, and dwarf planets like Pluto. The inner planets - Mercury, Venus, Earth, and Mars - are rocky, while the outer planets - Jupiter, Saturn, Uranus, and Neptune - are gas giants. The solar system is held together by the Sun's gravitational pull, with each celestial body following its own orbital path. This cosmic neighborhood extends far beyond the planets, encompassing the Kuiper Belt and the theoretical Oort Cloud at its outer reaches.",
    ]
